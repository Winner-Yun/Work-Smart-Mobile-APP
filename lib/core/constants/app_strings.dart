...
class AppStrings {
  ...
  static const Map<String, Map<String, String>> data = {
    'en': {
      ...
      'every_months': 'Every Monthes',
      'group_average': 'Group average',
      'total_reard':'Total reward',
      'on-time':' On Time',
    ...
    'km': {
      ...
      //admin-leaderboard
      'admin_ranking':'តារាងចំណាត់ថ្នាក់',
      'every_week':'ប្រចាំសប្តាហ៍',
      'every_months':'ប្រចាំខែ',
      'group_average':'សរុប',
      'total_reard':'មធ្យមភាគក្រុម',
      'on-time': 'ទាន់ពេលវេលា',
      'give_reward':'ពានរង្វាន់'
       //admin_leader
