...
class AchievementScreen extends StatelessWidget {
  ...
  Widget _buildStatsRow() {
    return Padding(
      ...
      child: Row(
        children: [
          _statItem("មេដាយសរុប", "១២", Icons.military_tech),
          const SizedBox(width: 15),
          _statItem("ចំណាត់ថ្នាក់", "#៥", Icons.leaderboard_outlined),
        ],
      ),
    );
  }
      ...
      children: [
        ...
        Expanded(
          child: GridView.builder(
            ...
            itemBuilder: (context, index) => _badgeItem(badges[index], index),
          ),
        ),
      ],
    );
  ...
  Widget _badgeItem(Map<String, dynamic> badge, int index) {
    return Column(
      children: [
        Container(
          ...
          child: Icon(
            badge['icon'],
            color: badge['locked'] ? Colors.grey[400] : badge['color'],
            size: 30,
          ),
        ),
        const SizedBox(height: 8),
        Text(
          ...
          style: TextStyle(
            fontSize: 11,
            fontWeight: FontWeight.bold,
            color: badge['locked'] ? Colors.grey : AppColors.textDark,
          ),
        ),
      ],
